...
import { ParseMessageFromBuffer, CopyInResponse, Authentication, ParameterStatus, BackendKeyData, ReadyForQuery, EmptyQueryResponse, RowDescription, DataRow, CommandComplete, ErrorResponse, NoticeResponse } from './backend_message.js'

describe("Authentication", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x52, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00]))
    expect(message).toBeInstanceOf(Authentication)
    expect(message.method).toBe(0)
  })

  test("should read a message correctly when using MD5_PASSWORD", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x52, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x10]))
    expect(message).toBeInstanceOf(Authentication)
  ...
  test("should read a message correctly when using CRYPT_PASSWORD", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x52, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x04, 0x00, 0x10]))
    expect(message).toBeInstanceOf(Authentication)
...
describe("ParameterStatus", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x53, 0x00, 0x00, 0x00, 0x16, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x00, 0x00]))
    expect(message).toBeInstanceOf(ParameterStatus)
...
describe("BackendKeyData", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x4b, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x95, 0xb4, 0x66, 0x62, 0xa0, 0xd5]))
    expect(message).toBeInstanceOf(BackendKeyData)
...
describe("ReadyForQuery", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x5a, 0x00, 0x00, 0x00, 0x05, 0x49]))
    expect(message).toBeInstanceOf(ReadyForQuery)
    expect(message.transactionStatus).toBe(0x49)
  })
})

describe("EmptyQueryResponse", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x49, 0x00, 0x00, 0x00, 0x04]))
    expect(message).toBeInstanceOf(EmptyQueryResponse)
  })
})

describe("RowDescription", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x54, 0x00, 0x00, 0x00, 0x1b, 0x00, 0x01, 0x69, 0x64, 0x00, 0x00, 0x00, 0x75, 0x9e, 0x00, 0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x08, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00]))
    expect(message).toBeInstanceOf(RowDescription)
...
describe("DataRow", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x44, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x70, 0x61, 0x69, 0x64]))
    expect(message).toBeInstanceOf(DataRow)
...
describe("CommandComplete", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([0x43, 0x00, 0x00, 0x00, 0x0b, 0x53, 0x45, 0x4c, 0x45, 0x43, 0x54, 0x00]))
    expect(message).toBeInstanceOf(CommandComplete)
...
describe("ErrorResponse", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([
    ...
    expect(message).toBeInstanceOf(ErrorResponse)
...
describe("NoticeResponse", () => {
  test("should read a message correctly", () => {
    ...
    expect(message).toBeInstanceOf(NoticeResponse)
...
describe("CopyInResponse", () => {
  test("should read a message correctly", () => {
    const message = ParseMessageFromBuffer(Buffer.from([71, 0, 0, 0, 7, 0, 0, 0]))
    expect(message).toBeInstanceOf(CopyInResponse)
