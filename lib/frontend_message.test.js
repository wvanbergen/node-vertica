...
describe("Startup", () => {
  test("should hold the message's information", () => {
    const topic = new FrontendMessage.Startup('username', 'database')
...
describe("CancelRequest", () => {
  test("should hold the correct information", () => {
    const topic = new FrontendMessage.CancelRequest(123, 456)
...
describe("Describe", () => {
  describe("Portal", () => {
    test("should hold the correct information", () => {
      const topic = new FrontendMessage.Describe('portal', 'name')
  ...
  describe("Prepared statement", () => {
    test("should hold the correct information", () => {
      const topic = new FrontendMessage.Describe('statement', 'name')
...
describe("Close", () => {
  describe("Portal", () => {
    test("should hold the correct information", () => {
      const topic = new FrontendMessage.Close('portal', 'name')
      expect(topic.type).toEqual(80)
      expect(topic.name).toEqual('name')
    })
  ...
  describe("Prepared statement", () => {
    test("should hold the correct information", () => {
      const topic = new FrontendMessage.Close('statement', 'name')
      expect(topic.type).toEqual(83)
      expect(topic.name).toEqual('name')
    })
...
describe("Query", () => {
  test("should hold the SQL query", () => {
    const topic = new FrontendMessage.Query("SELECT * FROM table")
  ...
  test("should encode non-latin UTF-8 strings", () => {
    const topic = new FrontendMessage.Query("SELECT 'Привет'")
...
describe("Parse", () => {
  test("should hold the name, query and parameter types", () => {
    const topic = new FrontendMessage.Parse("test", "SELECT * FROM table", [1, 2, 3])
...
describe("Bind", () => {
  test("should hold the portal, prepared statement name and parameter values", () => {
    const topic = new FrontendMessage.Bind("portal", "prep", ["hello", "world", 123])
...
describe("Flush", () => {
  test("should encode the message correctly", () => {
    const topic = new FrontendMessage.Flush()
...
describe("Execute", () => {
  test("should hold portal name and maximum number of rows", () => {
    const topic = new FrontendMessage.Execute('portal', 100)
    expect(topic.portal).toEqual('portal')
...
describe("Sync", () => {
  test("should encode the message correctly", () => {
    const topic = new FrontendMessage.Sync()
...
describe("Terminate", () => {
  test("should encode the message correctly", () => {
    const topic = new FrontendMessage.Terminate()
...
describe("SSLRequest", () => {
  test("should encode the message correctly", () => {
    const topic = new FrontendMessage.SSLRequest()
...
describe("Password", () => {
  test("should encode cleartext password messages correctly", () => {
    const topic = new FrontendMessage.Password('password')
...
describe("CopyDone", () => {
  test("should format the message correctly", () => {
    const topic = new FrontendMessage.CopyDone()
...
describe("CopyFail", () => {
  test("should format the message correctly", () => {
    const topic = new FrontendMessage.CopyFail('error')
...
describe("CopyData", () => {
  test("should format the message correctly", () => {
    const topic = new FrontendMessage.CopyData(Buffer.from('123'))
  ...
  test("should work with both strings and buffers", () => {
    const topic = new FrontendMessage.CopyData(Buffer.from('123'))
    const other = new FrontendMessage.CopyData('123')
