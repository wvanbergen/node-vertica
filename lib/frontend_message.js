(function() {
  ...
  FrontendMessage.Close = (function() {
    ...
    function Close(type, name) {
      var _ref;
      this.name = name;
      if ((_ref = this.name) == null) this.name = "";
      this.type = (function() {
        switch (type) {
          case 'portal':
          case 'p':
  ...
  FrontendMessage.Execute = (function() {
    ...
    function Execute(portal, maxRows) {
      ...
      if ((_ref = this.portal) == null) this.portal = "";
      if ((_ref2 = this.maxRows) == null) this.maxRows = 0;
    }
  ...
  FrontendMessage.Parse = (function() {
    ...
    function Parse(name, sql, parameterTypes) {
      ...
      if ((_ref = this.name) == null) this.name = "";
      if ((_ref2 = this.parameterTypes) == null) this.parameterTypes = [];
    }
