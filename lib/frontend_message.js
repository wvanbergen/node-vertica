...
FrontendMessage.ConnectionLoadBalance = (function(_super) {
  __extends(ConnectionLoadBalance, _super);

  function ConnectionLoadBalance() {
    return ConnectionLoadBalance.__super__.constructor.apply(this, arguments);
  }

  ConnectionLoadBalance.prototype.typeId = null;

  ConnectionLoadBalance.prototype.payload = function() {
    var arr, pl;
