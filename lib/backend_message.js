...
BackendMessage.ConnectionLoadBalanceResponse = (function(_super) {
  __extends(ConnectionLoadBalanceResponse, _super);

  function ConnectionLoadBalanceResponse() {
    return ConnectionLoadBalanceResponse.__super__.constructor.apply(this, arguments);
  }

  ConnectionLoadBalanceResponse.prototype.typeId = 89;

  ConnectionLoadBalanceResponse.prototype.read = function(buffer) {
    return this.host = buffer.toString('ascii', 4, buffer.length - 1);
  };
