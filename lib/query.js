...
Query = (function(_super) {
  ...
  Query.prototype.onEmptyQuery = function() {
    if (this.callback) {
      return this.error = "The query was empty!";
    } else {
      return this.emit('error', "The query was empty!");
    }
  };
  ...
  Query.prototype.onRowDescription = function(msg) {
    ...
    if ((this.callback != null) && (this.status != null)) {
      throw new Error("Cannot handle multi-queries with a callback!");
    }
    customDecoders = {};
  ...
  Query.prototype._getCopyInHandler = function() {
    ...
    if (typeof this.copyInSource === 'function') {
      ...
      if (existsSync(this.copyInSource)) {
        ...
        throw new Error("Could not find local file " + this.copyInSource + ".");
      }
