(function() {
  ...
  Query = (function() {
    ...
    Query.prototype.onEmptyQuery = function() {
      if (!this.callback) {
        this.emit('error', "The query was empty!");
      }
      if (this.callback) {
        return this.callback("The query was empty!");
      }
    };
    ...
    Query.prototype.onCopyInResponse = function(msg) {
      ...
      dataHandler = __bind(function(data) {
        return this.copyData(data);
      }, this);
      successHandler = __bind(function() {
        return this.copyDone();
      }, this);
      failureHandler = __bind(function(err) {
