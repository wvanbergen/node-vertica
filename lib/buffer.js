(function() {
  var Buffer, _ref, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  Buffer = require('buffer').Buffer;
    if ((_ref = Buffer.prototype.writeUInt8) != null) {
    _ref;
  } else {
    Buffer.prototype.writeUInt8 = function(number, offset) {
      this[offset] = number & 0xff;
    };
  };
    if ((_ref2 = Buffer.prototype.writeUInt16) != null) {
    _ref2;
  } else {
    Buffer.prototype.writeUInt16 = function(number, offset, endian) {
      return this._writeUInt(2, number, offset, endian);
    };
  };
    if ((_ref3 = Buffer.prototype.writeUInt32) != null) {
    _ref3;
  } else {
    Buffer.prototype.writeUInt32 = function(number, offset, endian) {
      return this._writeUInt(4, number, offset, endian);
    };
  };
    if ((_ref4 = Buffer.prototype._writeUInt) != null) {
    _ref4;
  } else {
    Buffer.prototype._writeUInt = function(bytes, number, offset, endian) {
    ...
    if ((_ref5 = Buffer.prototype.writeZeroTerminatedString) != null) {
    _ref5;
  } else {
    ...
    if ((_ref6 = Buffer.prototype.readUInt8) != null) {
    _ref6;
  } else {
    ...
    if ((_ref7 = Buffer.prototype.readUInt16) != null) {
    _ref7;
  } else {
    ...
    if ((_ref8 = Buffer.prototype.readUInt32) != null) {
    _ref8;
  } else {
    ...
    if ((_ref9 = Buffer.prototype._readUInt) != null) {
    _ref9;
  } else {
    Buffer.prototype._readUInt = function(bytes, offset, endian) {
    ...
    if ((_ref10 = Buffer.prototype.readZeroTerminatedString) != null) {
    _ref10;
  } else {
